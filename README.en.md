...
Sibling of [wrangler-ephemeral-chat](https://github.com/MauricioPerera/wrangler-ephemeral-chat) ([landing page](https://mauricioperera.github.io/wrangler-ephemeral-chat/)) — same pattern (Durable Objects + `wrangler deploy --temporary`), but for drawing instead of chatting.
